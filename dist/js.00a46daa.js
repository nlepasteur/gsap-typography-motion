...
var timeline = _gsap.gsap.timeline({
  paused: true
}).addLabel("start").staggerTo(DOM.content.home.chars, timelineSettings.charsDuration, {
  ease: "Power3.easeIn",
  y: "-100%",
  opacity: 0
}, timelineSettings.staggerValue, "start").addLabel("switchtime").add(function () {
...
}, "switchime-=timelineSettings.charsDuration/4").set(DOM.content.about.chars, {
  y: "100%"
}, "switchtime").set(DOM.content.about.picture, {
  y: "40%",
  rotation: -4,
  opacity: 0
}, "switchime").staggerTo(DOM.content.about.chars, timelineSettings.charsDuration, {
  ease: "Power3.easeOut",
  y: "0%"
}, timelineSettings.staggerValue, "switchtime").to(DOM.content.about.picture, 0.8, {
  ease: "Power3.easeOut",
  y: "0%",
  opacity: 1,
  rotation: 0
...
},{"splitting/dist/splitting.css":"../node_modules/splitting/dist/splitting.css","splitting/dist/splitting-cells.css":"../node_modules/splitting/dist/splitting-cells.css","splitting":"../node_modules/splitting/dist/splitting.js","gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
